...
When rms of wrist HRV increases by 1, we expect the odds of being stressed versus amused to multiply by a factor of `r round(exp(0.282), 3)` (`r round(exp(0.17028), 3)`, `r round(exp(0.39371), 3)`), holding all else constant.
