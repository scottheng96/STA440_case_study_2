...
train = temp_chest_eng_df[idx, ]
test = temp_chest_eng_df[-idx, ]
...
Next, we calculated features for the different modalities, which are displayed in Table #.  Segmentation of the physiological signals was done using a sliding window, with a window shift of 0.25 seconds. The ACC features were calculated with a 5 second window size [[3]][Bibliography] and the physiological features were calculated using a 60 second window size [[4]][Bibliography]. 
