...
lr_model_final_wrist_chest <- train(label ~ sd_EDA + sd_EDA_wrist + sd_Temp_chest + 
                                    ...
                                    method = "glm",
                                    family ="binomial")
summary(lr_model_final_wrist_chest)
```
...
lr_model_final_wrist_coef_tidy_df %>% 
  ...
  kableExtra::kable( booktabs = T,  escape = F, 
                     caption = "Cofficients obtained with Model 1 (Wrist Model)",
...
lr_model_final_wrist_coef_tidy_df %>% 
  ...
  kableExtra::kable(booktabs = T,  escape = F, 
                    caption = "Cofficients obtained with Model 1 - Quantifying Hetereogeneity") 
```
...
lr_model_final_wrist_chest_coef_tidy_df %>% 
  ...
  kableExtra::kable( booktabs = T, escape = F, 
                     caption = "Cofficients obtained with  Model 2 (Chest and Wrist Model)",
                     col.names = c("Coefficient", "Estimate", "Std. Error", "p-value")) %>% 
  #kable_styling(latex_options = c("hold_position")) %>% 
...
lr_model_final_wrist_chest_coef_tidy_df %>% 
  ...
  mutate_if(is.double, round, digits = 3) %>%
  kableExtra::kable(booktabs = T,  escape = F, 
                    caption = "Cofficients obtained with Model 2 - Quantifying Hetereogeneity") 
```
