...
calc_metrics = function(model, testing_data) {
  list = list()
  acc_list = c()
  f1_list = c()
  AUC_list = c()
...
calc_metrics(lr_model_final_wrist, test) %>%   kable(booktabs = T, 
...
#   label ~ participant +  sd_EDA_wrist + sd_ACC_chest_mag, data=train, 
