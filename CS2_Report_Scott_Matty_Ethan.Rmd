...
arm::binnedplot(x=aug_wrist$.fitted,y=aug_wrist$.resid,xlab="Predicted Probabilities", 
                main = "Binned Residual vs. Predicted Values")

aug_chest_wrist <- augment(lr_model_final_wrist_chest$finalModel, type.predict = "response", 
                     type.residuals = "deviance")

arm::binnedplot(x=aug_chest_wrist$.fitted,y=aug_chest_wrist$.resid,xlab="Predicted Probabilities", 
                main = "Binned Residual vs. Predicted Values")
